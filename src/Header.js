		...
		<header className={fixed ? 'site-header site-header-sticky' : 'site-header'} >
			...
			<nav className="header-nav" id="navigation">
				<ul className="nav-menu">
					...
					<li ref={addAdditionalRefs} className="nav-menu-item cv item-additional"><a href="https://wp.spatovaliyski.com/martins-resume/" target="_blank" rel="noreferrer">Resume</a></li>
				</ul>
